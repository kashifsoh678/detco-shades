                    ...
                    <div className="lg:col-span-4 space-y-8 relative">
                        <div className="sticky top-42">
                            ...
                            <div className="mt-8 bg-teal-50 rounded-3xl p-8 border border-white shadow-sm text-center">
                                ...
                                <a href="tel:+966507450956" className="mb-4 inline-flex items-center justify-center w-full py-3 bg-white text-primary font-bold rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100">
                                    Call +966507450956
                                </a>
                                <a href="tel:0530275784" className="inline-flex items-center justify-center w-full py-3 bg-white text-primary font-bold rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100">
                                    Call 0530275784
                                </a>
                            </div>
                        </div>
